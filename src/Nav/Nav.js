  ...
  return (<>
    ...
    <Box>
      <AppBar position="start">
        ...
        <div className='col-lg-6'>
            ...
            component="div"
            // onClick={(nav1)}
            className="navcontent d-none d-lg-block"
            sx={{ flexGrow: 1, fontFamily: 'monospace' }}
          >

            <Search className='d-xs-none d-lg-block' >
   ...
   {state.cart.length > 0 ? ( 
       <div className='cartrows'>
        ...
        <div  className='navbox col-lg-12 d-xs-none d-md-none'>
      ...
      <div className='col-lg-7 navoffer'>
          ...
          >
            ...
            <Search >
              ...
              <StyledInputBase className='searchinps'
                placeholder="Search…"
                inputProps={{ 'aria-label': 'search' }}
                onChange={e=>dispatch({type:"SEARCH",payload:e.target.value})}
              />
