        ...
        <div class="fruitcontainer">
           ...
           {sortedProduct().map((value,index)=>{
                      ...
                      <Card sx={{ maxWidth: 300 }} className='cardcolor'>
                        <div className='image-card col-xs-5' onClick={()=>productShow(value)}>
                            <CardMedia
                            ...
                            <h5 className='offer'>GET {value.offer} % OFF<Icon icon="bxs:offer" className="offericon d-xs-none" /></h5>
                            ...
                            <div className="contents">
                             ...
                             <div className='cardflex d-xs-none'>
                                ...
                                <div className='d-xs-none'>
                                 <h6>QUANTITY</h6>   
                                <button className='btn d-xs-none' onClick={()=>decrement(index)}>-</button>
                                <input class="inputcard d-xs-none" value={value.qty } size={1}/>
                                 <button className='btn d-xs-none' onClick={()=>increment(index)}>+</button>
                                    </div>
                                    <div>
                                    
                                        {cart.some(e => e.id === value.id) ? (
                                             <button className='footicon d-xs-none' onClick={()=>dispatch({type:"REMOVE",payload:value})} style={{backgroundColor:'red',color:'white'}}>REMOVE</button>
                                        ) : (
                                            <button className='footicon ' onClick={()=>dispatch({type:"CART",payload:value})} >ADD </button>
                                        )}
                                      </div>
