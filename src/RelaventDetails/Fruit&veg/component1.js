...
const Component1 = () => {
  ...
  console.log(discountSort_BETWEEN5TO10);
  ...
  const decrement = (id) => {
    vegetables[id].qty-=1
    dispatch({type:"DEC", payload:vegetables})
  };

  const increment = (id) => {
    vegetables[id].qty+=1
    dispatch({type:"INC", payload:vegetables})
  };
  ...
  const sortedProduct = () => {
    ...
    if (priceSort_BETWEEN50TO100 && priceSort_BETWEEN100TO200) {
      sortedArray = sortedArray.filter((item, index) => {
        return item.rupees >= 50 && item.rupees <=200;
      });
    }
  ...
  return (
    <div>
      ...
      <div class="fruitcontainer">
        <div class="fruitrow ">
          <div className="fruitcol1 d-none d-lg-block">
            <Sidebar/>
          </div>
            ...
            {sortedProduct().length > 0 ? (
              <div className="fruitcontent ">
                {sortedProduct().map((value, index) => {
                  return (
                    <>
                      <div className="fruitcol3 col-lg-3 col-xs-12 col-md-4">
