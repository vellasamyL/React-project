...
const Footer = () =>{
    return(
        <div className="footer">
            <div className="footer-card col-lg-3 col-xs-6 col-md-6">
                <h4>bigbasket</h4>
                <ul>
                    <li>About Us</li>
                    <li>In News</li>
            ...
            <div className="footer-card col-lg-3 col-xs-5 col-md-6">
                <h4>Help</h4>
                <ul>
                    <li>FAqs</li>
                    <li>contact Us</li>
            ...
            <div className="footer-card col-lg-3 col-xs-12 col-md-12">
                <h4>Download Our App</h4>
                <ul className="myli col-xs-6 col-md-6">
            ...
            <div className="footer-card col-lg-3">
